...
private:
     ...
     */
    void setOrganisationName(const QString organisationName) { _organisationName = organisationName; }
...
public:
     ...
     */
    QString organisationName() const { return _organisationName; }
     ...
     */
    bool hasResponse() const { return _hasResponse; }
     ...
     */
    bool responseSuccessfull() const { return _responseSuccess; }
    /*! @brief Returns the response text
     *  @return The response text
     */
    QString responseText() const { return _responseText; }
